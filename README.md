...
A Clojure library designed to make rpg-style stat bars, using [clansi](https://github.com/ams-clj/clansi) for coloring.  There may be color correction issues when using different colorized terminals.
